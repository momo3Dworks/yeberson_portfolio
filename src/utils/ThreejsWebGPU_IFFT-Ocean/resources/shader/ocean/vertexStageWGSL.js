...
export const vertexStageWGSL = (() => {
    ...
    fn WGSLPosition(
        ...
        var samplePos: vec2<f32> = morphedPosition.xz + globalOffset;

        var vtexelCoord0: vec2<f32> = ifftResolution * samplePos/waveLengths.x;
        var vtexelCoord1: vec2<f32> = ifftResolution * samplePos/waveLengths.y;
        var vtexelCoord2: vec2<f32> = ifftResolution * samplePos/waveLengths.z;
