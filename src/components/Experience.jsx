...
export default function Experience({ sharedHUD, oceanConfig, onLoaded }) {
  ...
  return (
    <Suspense fallback={null}>
      ...
      <Ocean sharedHUD={sharedHUD} oceanConfig={oceanConfig} oceanReflector={oceanReflector} onLoaded={onLoaded} />
    </Suspense>
  );
}
